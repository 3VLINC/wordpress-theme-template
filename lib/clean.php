...
if( ! function_exists( 'reverie_scripts_and_styles ' ) ) {
	function reverie_scripts_and_styles() {
	  if (!is_admin()) {
	    ...
	    // adding jQuery Parallax
	    wp_register_script('jquery.stellar', get_template_directory_uri().'/bower_components/jquery.stellar/jquery.stellar.min.js',array('jquery'), '0.6.2', true );
	    
	    // adding Foundation scripts file in the footer
	    wp_register_script( 'app', get_template_directory_uri() . '/js/app.js', array( 'jquery','jquery.stellar','reverie-js' ), '', true );
